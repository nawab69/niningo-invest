    ...
    <section class="page-header bg_img oh" data-background="{{url('/')}}/frontend/images/page-header.png">
        ...
        <div class="container">
            <div class="page-header-content cl-white">
                <h2 class="title">Our Terms and Services</h2>
                <ul class="breadcrumb">
                    <li>
                        <a href="/">Home</a>
                    </li>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section-header">
                        <h2 class="title">Terms and Services</h2>
                        <p>Please read this Terms and Services carefully before using this website</p>
                    </div>
                </div>
            </div>
